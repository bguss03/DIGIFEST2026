  ...
  return (
    <div className="flex flex-col items-center">
      <div className="pt-15 text-center min-h-screen flex flex-col items-center justify-center text-8xl font-bold font-mono">
        <h1 className="font-mono text-2xl sm:text-6xl text-transparent bg-clip-text bg-linear-to-r from-[#e21c70] to-[#191b37]">
          Are You Ready?
        </h1>
        <ShinyText
          text="DIGIFEST 2026"
        ...
        />
        <div className="">
          <h1 className="text-sm sm:text-4xl font-mono text-[#e21c70] [-webkit-text-stroke:1px_#191b37]">
