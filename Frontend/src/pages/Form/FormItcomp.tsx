...
export default function FormItComp() {
  ...
  const [step, setStep] = useState(() => {
    const savedStep = localStorage.getItem("form_itcomp_step");
  ...
  useEffect(() => {
    ...
    localStorage.setItem("form_itcomp_data", JSON.stringify(dataToSave));
  }, [formData]);

  useEffect(() => {
    localStorage.setItem("form_itcomp_step", step.toString());
  }, [step]);

  const validateStep = () => {
    switch (step) {
      case 1:
        return formData.namaTim.trim() !== "";
      case 2:
        return (
          formData.namaKetua.trim() !== "" &&
          formData.noKetua.trim() !== "" &&
          formData.nimKetua.trim() !== "" &&
        ...
        message: (
          <div className="space-y-4">
            ...
            <div className="w-full bg-green-50/10 border border-green-500/20 rounded-2xl p-4 mb-6 backdrop-blur-sm">
              ...
              <a
                href="https://chat.whatsapp.com/FysTSvqQHwg1Nsjp8wSbyu"
                target="_blank"
              ...
              <motion.div variants={itemVariants} className="flex flex-col">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-[10px] mb-1 truncate w-full px-1 ${isInvalid(["suratAnggota3"]) ? "text-red-600 font-semibold" : "text-white"}`}
                    >
                      {formData.suratAnggota3
                        ? formData.suratAnggota3.name
                        : "Klik untuk upload PDF"}
                    </p>
                    <p className="text-[8px] text-white/50">Maks 10MB</p>
                  </label>
              ...
              <motion.div variants={itemVariants} className="flex flex-col">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-[10px] mb-1 truncate w-full px-1 ${isInvalid(["buktiFollowAnggota3"]) ? "text-red-600 font-semibold" : "text-white"}`}
                    >
                      {formData.buktiFollowAnggota3
                        ? formData.buktiFollowAnggota3.name
                        : "Klik untuk upload Gambar"}
                    </p>
                    <p className="text-[8px] text-white/50">Maks 10MB</p>
                  </label>
              ...
              <motion.div variants={itemVariants} className="flex flex-col">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-[10px] mb-1 truncate w-full px-1 ${isInvalid(["buktiPostA3"]) ? "text-red-600 font-semibold" : "text-white"}`}
                    >
                      {formData.buktiPostA3
                        ? formData.buktiPostA3.name
                        : "Klik untuk upload Gambar"}
                    </p>
                    <p className="text-[8px] text-white/50">Maks 10MB</p>
                  </label>
              ...
              <motion.div variants={itemVariants} className="flex flex-col">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-[10px] mb-1 truncate w-full px-1 ${isInvalid(["suratAnggota4"]) ? "text-red-600 font-semibold" : "text-white"}`}
                    >
                      {formData.suratAnggota4
                        ? formData.suratAnggota4.name
                        : "Klik untuk upload PDF"}
                    </p>
                    <p className="text-[8px] text-white/50">Maks 10MB</p>
                  </label>
              ...
              <motion.div variants={itemVariants} className="flex flex-col">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-[10px] mb-1 truncate w-full px-1 ${isInvalid(["buktiFollowAnggota4"]) ? "text-red-600 font-semibold" : "text-white"}`}
                    >
                      {formData.buktiFollowAnggota4
                        ? formData.buktiFollowAnggota4.name
                        : "Klik untuk upload Gambar"}
                    </p>
                    <p className="text-[8px] text-white/50">Maks 10MB</p>
                  </label>
              ...
              <motion.div variants={itemVariants} className="flex flex-col">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-[10px] mb-1 truncate w-full px-1 ${isInvalid(["buktiPostA4"]) ? "text-red-600 font-semibold" : "text-white"}`}
                    >
                      {formData.buktiPostA4
                        ? formData.buktiPostA4.name
                        : "Klik untuk upload Gambar"}
                    </p>
                    <p className="text-[8px] text-white/50">Maks 10MB</p>
                  </label>
