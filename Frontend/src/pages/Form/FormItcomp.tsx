          ...
          >
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative w-full">
                {/* Ikon WhatsApp SVG */}
                <div className="absolute left-3.5 top-1/2 -translate-y-1/2 text-pink-500 flex items-center justify-center">
                  <svg
                    stroke="currentColor"
                    fill="none"
                    strokeWidth="2"
              ...
              <motion.div variants={itemVariants} className="flex flex-col">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-sm mb-1 truncate w-full px-2 ${isInvalid(["suratAnggota3"]) ? "text-red-600 font-semibold" : "text-[#191b37]"}`}
                    >
              ...
              <motion.div variants={itemVariants} className="flex flex-col">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-sm mb-1 truncate w-full px-2 ${isInvalid(["buktiFollowAnggota3"]) ? "text-red-600 font-semibold" : "text-[#191b37]"}`}
                    >
              ...
              <motion.div variants={itemVariants} className="flex flex-col">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-sm mb-1 truncate w-full px-2 ${isInvalid(["suratAnggota4"]) ? "text-red-600 font-semibold" : "text-[#191b37]"}`}
                    >
              ...
              <motion.div variants={itemVariants} className="flex flex-col">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={`text-sm mb-1 truncate w-full px-2 ${isInvalid(["buktiFollowAnggota4"]) ? "text-red-600 font-semibold" : "text-[#191b37]"}`}
                    >
