...
const techLogos = [
  ...
  { node: <SiNextdotjs className="w-full h-full text-black" />, title: "Next.js", href: "https://nextjs.org" },
...
export default function MediaPartner() {
  return (
    <div id="MediaPartner" className="py-20 bg-transparent overflow-hidden">
