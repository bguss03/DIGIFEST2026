...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-black/20 backdrop-blur-lg text-white font-montserrat pt-16 pb-8 px-6 sm:px-12 md:px-20">
      <div className="max-w-7xl mx-auto flex flex-col">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-12">
          <div className="md:col-span-6 lg:col-span-5 flex flex-col space-y-6">
            <div className="flex items-center space-x-3">
              <div className="h-12 w-auto flex items-center justify-center">
                  <img src="/digifest.svg" alt="DIGIFEST Logo" className="h-12 w-auto" />
              </div>
            </div>
            <p className="text-sm text-white max-w-md opacity-75 leading-relaxed">
          ...
          <div className="md:col-span-3 flex flex-col">
            <h2 className="text-white text-lg font-bold mb-6 relative inline-block">
              Quick Links
              <span className="absolute -bottom-1 left-0 w-8 h-1 bg-brand-sun rounded-full"></span>
            </h2>
            <nav className="flex flex-col space-y-3 text-sm font-medium">
              <NavLink
                to="#Beranda"
                onClick={(e) => handleNavClick(e, "#Beranda")}
                className="text-white/70 hover:text-brand-sun transition-colors duration-300 flex items-center"
              >
                Beranda
              </NavLink>
              <NavLink
                ...
                className="text-white/70 hover:text-brand-sun transition-colors duration-300"
              >
                Tentang
              </NavLink>
              <NavLink
          ...
          <div className="md:col-span-3 flex flex-col">
            ...
            <div className="flex flex-col space-y-4 text-sm font-medium">
              <a 
                ...
                className="text-white/70 hover:text-brand-sun transition-colors duration-300 flex items-center gap-3"
              >
            ...
            <div className="flex flex-row space-x-3 mt-8">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 flex items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white hover:bg-brand-sun hover:text-brand-midnight hover:-translate-y-1 transition-all duration-300"
                >
                  <social.icon size={18} />
                </a>
              ))}
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs sm:text-sm font-medium opacity-60">
